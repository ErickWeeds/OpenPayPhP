...
if ($_POST) {
    $openpay = Openpay::getInstance('m67tf4pypcwegcemnjor', 'sk_0ed7dfdadaea464abaf5f947080cd79a');
    $chargeData = array(
        'method' => 'card',
    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                OpenPay.setId('m67tf4pypcwegcemnjor');
                OpenPay.setApiKey('sk_0ed7dfdadaea464abaf5f947080cd79a');
            ...
            <div class="pymnts">
                <form action="#" method="POST" id="payment-form">
                    ...
                    <div class="pymnt-itm card active">
                        <h2>Tarjeta de cr&eacute;dito o d&eacute;bito</h2>
                        <div class="pymnt-cntnt">
                            ...
                            <div class="sctn-row">
                                ...
                                <div class="sctn-col">
                                    <label>N&uacute;mero de tarjeta</label><input type="text" autocomplete="off" data-openpay-card="card_number"></div>
                            </div>
                            <div class="sctn-row">
                                <div class="sctn-col l">
                                    ...
                                    <div class="sctn-col half l"><input type="text" placeholder="A&ntilde;o" data-openpay-card="expiration_year"></div>
                                </div>
                                <div class="sctn-col cvv"><label>C&oacute;digo de seguridad</label>
                                    <div class="sctn-col half l"><input type="text" placeholder="3 d&iacute;gitos" autocomplete="off" data-openpay-card="cvv2"></div>
                                </div>
                            </div>
                            <div class="openpay"><div class="logo">Transacciones realizadas v&iacute;a:</div>
